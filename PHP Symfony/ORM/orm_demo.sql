...
-- Dumping structure for table orm_demo.cars
...
-- Dumping data for table orm_demo.cars: ~358 rows (approximately)
...
-- Dumping structure for table orm_demo.cars_parts
CREATE TABLE IF NOT EXISTS `cars_parts` (
  `car_id` int(11) NOT NULL,
  `part_id` int(11) NOT NULL,
  PRIMARY KEY (`car_id`,`part_id`),
  KEY `IDX_F30DF478C3C6F69F` (`car_id`),
  KEY `IDX_F30DF4784CE34BEC` (`part_id`),
  CONSTRAINT `FK_F30DF4784CE34BEC` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`),
  CONSTRAINT `FK_F30DF478C3C6F69F` FOREIGN KEY (`car_id`) REFERENCES `cars` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table orm_demo.cars_parts: ~1,170 rows (approximately)
...
-- Dumping structure for table orm_demo.customers
...
-- Dumping data for table orm_demo.customers: ~30 rows (approximately)
/*!40000 ALTER TABLE `customers` DISABLE KEYS */;
INSERT INTO `customers` (`id`, `name`, `birth_day`, `is_young_driver`) VALUES
	(1, 'Emmitt Benally', '1993-11-20 00:00:00', 1),
	(2, 'Natalie Poli', '1990-10-04 00:00:00', 0),
	(3, 'Marcelle Griego', '1990-10-04 00:00:00', 1),
	(4, 'Zada Attwood', '1982-10-01 00:00:00', 1),
	(5, 'Hai Everton', '1985-10-01 00:00:00', 1),
	(6, 'Lino Subia', '1985-12-21 00:00:00', 0),
	(7, 'Rico Peer', '1984-10-01 00:00:00', 1),
	(8, 'Teddy Hobby', '1975-10-01 00:00:00', 1),
	(9, 'Johnette Derryberry', '1995-10-01 00:00:00', 1),
	(10, 'Audrea Cardinal', '1976-10-01 00:00:00', 0),
	(11, 'Francis Mckim', '1977-10-01 00:00:00', 1),
	(12, 'Carole Witman', '1987-10-01 00:00:00', 0),
	(13, 'Oren Perlman', '1988-10-01 00:00:00', 1),
	(14, 'Brett Brickley', '1980-10-01 00:00:00', 1),
	(15, 'Kristian Engberg', '1981-10-03 00:00:00', 0),
	(16, 'Carri Knapik', '1972-02-02 00:00:00', 1),
	(17, 'Rema Revelle', '1970-05-01 00:00:00', 1),
	(18, 'Taina Achenbach', '1994-10-01 00:00:00', 0),
	(19, 'Yvonne Mccalla', '1992-03-02 00:00:00', 1),
	(20, 'Nisha Markwell', '1994-04-04 00:00:00', 0),
	(21, 'Cinthia Lasala', '1992-11-01 00:00:00', 1),
	(22, 'Daniele Zarate', '1995-10-05 00:00:00', 0),
	(23, 'Faustina Burgher', '1994-06-01 00:00:00', 0),
	(24, 'Jimmy Grossi', '1986-07-01 00:00:00', 1),
	(25, 'Sylvie Mcelravy', '1983-10-01 00:00:00', 0),
	(26, 'Hipolito Lamoreaux', '1982-08-01 00:00:00', 1),
	(27, 'Garret Capron', '1975-07-01 00:00:00', 0),
	(28, 'Donnetta Soliz', '1963-10-01 00:00:00', 1),
	(30, 'Ann Mcenaney', '1992-03-02 00:00:00', 1);
/*!40000 ALTER TABLE `customers` ENABLE KEYS */;

-- Dumping structure for table orm_demo.parts
CREATE TABLE IF NOT EXISTS `parts` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_6940A7FE2ADD6D8C` (`supplier_id`),
  CONSTRAINT `FK_6940A7FE2ADD6D8C` FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=132 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table orm_demo.parts: ~131 rows (approximately)
/*!40000 ALTER TABLE `parts` DISABLE KEYS */;
INSERT INTO `parts` (`id`, `supplier_id`, `name`, `price`, `quantity`) VALUES
	(2, 22, 'Unexposed bumper', 1003.34, 10),
	(3, 20, 'Exposed bumper', 1400.34, 10),
	(4, 19, 'Cowl screen', 1500.34, 10),
	(5, 2, 'Decklid', 1060.34, 11),
	(6, 31, 'Fascia', 100.34, 10),
	(7, 30, 'Fender', 10.34, 10),
	(8, 13, 'Front clip', 100.00, 10),
	(9, 11, 'Front fascia', 11.99, 10),
	(10, 15, 'Grille', 144.99, 10),
	(11, 13, 'Pillar', 100.99, 10),
	(12, 27, 'Quarter panel', 100.99, 200),
	(13, 6, 'Radiator ', 100.99, 10),
	(14, 4, 'Rocker', 100.99, 10),
	(15, 8, 'Roof rack', 100.99, 10),
	(16, 12, 'Spoiler', 3000.99, 10),
	(17, 21, 'Rims', 4020.99, 10),
	(18, 5, 'Trim package', 1900.99, 10),
	(19, 3, 'Trunk/boot/hatch', 2200.99, 300),
	(20, 17, 'Valance', 1002.99, 10),
	(21, 16, 'Welded assembly', 1020.99, 10),
	(22, 14, 'Front Right Outer door handle', 999.99, 345),
	(23, 28, 'Front Left Side Outer door handle', 999.99, 10),
	(24, 27, 'Rear Right Side Outer door handle', 80.99, 10),
	(25, 30, 'Rear Left Side Outer door handle', 120.99, 10),
	(26, 28, 'Front Right Side Inner door handle', 100.99, 10),
	(27, 12, 'Front Left Side Inner door handle', 77.99, 1032),
	(28, 10, 'Rear Right Side Inner door handle', 79.99, 10),
	(29, 8, 'Rear Left Side Inner door handle', 93.99, 234),
	(30, 23, 'Back Door Outer Door Handle', 43.99, 10),
	(31, 1, 'Front Right Side Window motor', 44.99, 10),
	(32, 31, 'Front Left Side Window motor', 56.99, 10),
	(33, 29, 'Rear Right Side Window motor', 22.99, 10),
	(34, 12, 'Rear Left Side Window motor', 144.99, 10),
	(35, 11, 'Door control module', 421.99, 10),
	(36, 25, 'Door seal', 444.99, 10),
	(37, 23, 'Door water-shield', 123.99, 10),
	(38, 22, 'Hinge', 11.99, 10),
	(39, 5, 'Door latch', 2331.99, 10),
	(40, 23, 'Door lock and power door locks', 120.99, 10),
	(41, 7, 'Center-locking', 313.99, 10),
	(42, 11, 'Fuel tank', 100.98, 10),
	(43, 25, 'Front Right Side Door Glass', 100.91, 10),
	(44, 24, 'Front Left Side Door Glass', 100.92, 10),
	(45, 7, 'Rear Right Side Door Glass', 100.90, 10),
	(46, 5, 'Rear Left Side Door Glass', 100.66, 10),
	(47, 4, 'Rear Right Quarter Glass', 100.66, 10),
	(48, 18, 'Rear Left Quarter Glass', 100.55, 10),
	(49, 17, 'Sunroof', 103.43, 10),
	(50, 15, 'Sunroof Rail', 100.25, 10),
	(51, 29, 'Sunroof Glass', 205.24, 10),
	(52, 28, 'Window motor', 123.49, 10),
	(53, 6, 'Window regulator', 100.99, 10),
	(54, 20, 'Windshield', 100.99, 10),
	(55, 19, 'Window seal', 100.99, 10),
	(56, 22, 'Engine', 100.99, 10),
	(57, 20, 'Camshaft', 100.98, 10),
	(58, 19, 'Crank case', 2.93, 10),
	(59, 2, 'Crank pulley', 2.80, 10),
	(60, 5, 'Crankshaft', 4.99, 10),
	(61, 15, 'Cylinder head', 6.99, 10),
	(62, 13, 'Distributor', 7.99, 10),
	(63, 16, 'Distributor cap', 9.99, 10),
	(64, 15, 'Drive belt', 3.99, 10),
	(65, 13, 'Engine block', 40.99, 10),
	(66, 27, 'Engine cradle', 39.99, 10),
	(67, 26, 'Engine shake damper and vibration absorber', 100.99, 10),
	(68, 9, 'Engine valve', 49.99, 10),
	(69, 7, 'Fan belt', 10.99, 10),
	(70, 6, 'Gudgeon pin', 44.99, 10),
	(71, 20, 'Harmonic balancer', 67.99, 10),
	(72, 18, 'Heater', 82.99, 10),
	(73, 17, 'Piston', 94.99, 10),
	(74, 31, 'Poppet valve', 88.99, 10),
	(75, 29, 'Rocker arm', 98.99, 10),
	(76, 13, 'Rocker cover', 10.99, 10),
	(77, 11, 'Starter motor', 0.99, 10),
	(78, 10, 'Turbocharger', 0.40, 10),
	(79, 19, 'Tappet', 300.29, 10),
	(80, 2, 'Timing tape', 40.90, 10),
	(81, 1, 'Valve cover', 130.99, 10),
	(82, 30, 'Valve housing', 400.99, 10),
	(83, 13, 'Valve spring', 104.99, 10),
	(84, 12, 'Valve stem seal', 120.99, 10),
	(85, 26, 'Water pump pulley', 150.99, 10),
	(86, 5, 'Air blower', 140.99, 10),
	(87, 3, 'Coolant hose ', 150.99, 10),
	(88, 1, 'Cooling fan', 120.99, 10),
	(89, 4, 'Fan blade', 150.99, 10),
	(90, 3, 'Fan clutch', 120.99, 10),
	(91, 17, 'Radiator bolt', 160.99, 10),
	(92, 21, 'Radiator (fan) shroud', 300.99, 10),
	(93, 30, 'Radiator gasket', 140.99, 10),
	(94, 28, 'Radiator pressure cap', 600.99, 10),
	(95, 26, 'Overflow tank', 1200.99, 10),
	(96, 10, 'Thermostat', 1050.99, 10),
	(97, 8, 'Water neck', 900.99, 10),
	(98, 7, 'Water neck o-ring', 43.99, 10),
	(99, 21, 'Water pipe', 44.94, 10),
	(100, 19, 'Water pump', 44.93, 10),
	(101, 3, 'Water pump gasket', 120.29, 10),
	(102, 12, 'Water tank', 100.99, 10),
	(103, 10, 'Oil filter', 200.99, 10),
	(104, 9, 'Oil gasket', 130.99, 10),
	(105, 23, 'Oil pan', 140.99, 10),
	(106, 21, 'Oil pipe', 100.29, 10),
	(107, 20, 'Oil pump', 100.19, 10),
	(108, 3, 'Oil strainer', 45.29, 10),
	(109, 1, 'Catalytic converter', 540.99, 10),
	(110, 16, 'Exhaust clamp and bracket', 140.99, 10),
	(111, 14, 'Exhaust flange gasket', 130.99, 10),
	(112, 12, 'Resonator', 106.99, 10),
	(113, 27, 'Muffler', 106.90, 10),
	(114, 25, 'Exhaust pipe', 130.99, 10),
	(115, 23, 'Heat shield', 10.99, 10),
	(116, 7, 'Air filter', 200.99, 10),
	(117, 5, 'Choke cable', 130.99, 10),
	(118, 15, 'Fuel cooler', 140.99, 10),
	(119, 29, 'Fuel filter', 162.99, 10),
	(120, 27, 'Fuel rail', 107.99, 10),
	(121, 26, 'Fuel pressure regulator', 100.99, 10),
	(122, 9, 'Steering arm', 104.99, 10),
	(123, 7, 'Steering box', 103.99, 10),
	(124, 6, 'Clutch assembly', 120.99, 10),
	(125, 20, 'Master cylinder', 130.99, 10),
	(126, 23, 'Speed reducer', 14.99, 10),
	(127, 2, 'Transmission gear', 15.99, 10),
	(128, 31, 'Transmission pan', 106.99, 10),
	(129, 29, 'Differential seal', 109.99, 10),
	(130, 13, 'Differential clutch', 120.99, 10),
	(131, 11, 'Clutch shoe', 10.49, 10);
/*!40000 ALTER TABLE `parts` ENABLE KEYS */;

-- Dumping structure for table orm_demo.sales
CREATE TABLE IF NOT EXISTS `sales` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_6B817044C3C6F69F` (`car_id`),
  KEY `IDX_6B8170449395C3F3` (`customer_id`),
  CONSTRAINT `FK_6B8170449395C3F3` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`),
  CONSTRAINT `FK_6B817044C3C6F69F` FOREIGN KEY (`car_id`) REFERENCES `cars` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table orm_demo.sales: ~50 rows (approximately)
/*!40000 ALTER TABLE `sales` DISABLE KEYS */;
INSERT INTO `sales` (`id`, `car_id`, `customer_id`, `discount`) VALUES
	(1, 279, 28, 0.3),
	(2, 80, 16, 0.2),
	(4, 316, 11, 0.4),
	(5, 105, 18, 0.2),
...
-- Dumping structure for table orm_demo.suppliers
...
-- Dumping data for table orm_demo.suppliers: ~31 rows (approximately)
